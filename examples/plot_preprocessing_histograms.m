%% Plot histograms for preprocessing 
%
% This script generates histogram figures for the number of bad channels,
% number of bad ICs, amount of rejected time segments (in seconds), clean
% epochs left after preprocessing. It also reports on average
%
