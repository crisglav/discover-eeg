...
% Cristina Gil 14.02.2020
% Added parameters:
% plot_mean_lines             - logical set to true if you want lines

function h = rm_raincloud(data, colours, plot_top_to_bottom, density_type, bandwidth,plot_mean_lines)
...
% spacing = 1; % HARD CODED BY CRISTINA
...
cell_means = cellfun(@(x) mean(x,'omitnan'), data);
